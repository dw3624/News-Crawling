...
# 경향신문 단독 크롤링
base_url = 'https://search.naver.com/search.naver?where=news&sm=tab_pge&query=%EB%8B%A8%EB%8F%85&sort=1&photo=0&field=0&pd=3&ds=2021.01.01&de=2022.05.14&mynews=1&office_type=1&office_section_code=1&news_office_checked=1032&nso=so:dd,p:from20210101to20220514,a:all&start='
page = 1
articles = 'preset'
...
no_dup_df.to_csv('./data/경향신문단독뉴스.csv', encoding='utf-8-sig')
